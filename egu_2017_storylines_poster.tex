  ...
  \begin{column}{.3333\paperwidth} % if all columns have the same width, it's enough to declare that width once
   ...
   \begin{textblock}{\textwidth \TPHorizModule}(33.333,0)
    \begin{block}{3. Downscaling}
     ...
     \begin{figure}
      \center\includegraphics[width=0.85\linewidth]{figures/downscaling.png}
      \caption{Comparison of precipitation predicted using 4 different downscaling approaches in GARD. Row 1: Gridded (1/8 deg) observed precipitation from Maurer et al (2001), Row 2: 50-km WRF precipitation interpolated to observations grid, Row 3-5: precipitation derived from different statistical transformations. }
